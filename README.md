...
MAIL_PASSWORD=contraseña_de_aplicacion_de_google
MAIL_ENCRYPTION=tls
MAIL_FROM_ADDRESS=tu_email@gmail.com
MAIL_FROM_NAME=MANTIA
```
...
>
> **Correo con Gmail:** Google requiere una **"Contraseña de aplicación"** (App Password), no la contraseña normal de tu cuenta. Activá verificación en dos pasos en https://myaccount.google.com/ y generá una app password en https://myaccount.google.com/apppasswords
